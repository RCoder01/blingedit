...
summon minecraft:slime ~ ~ ~ {CustomName:"\"ClickDetector\"", Tags:["ClickDetector"], NoGravity:1b, NoAI: 1b, Invisible:1b, Silent:1b, Size:2, AbsorptionAmount: 100f, Invulnerable:1b}
scoreboard players add @e _age 1
