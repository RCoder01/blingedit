...
tellraw @s ["",{"text":"Clone Options: "},{"text":"[Do Clone Air]","click_event":{"action":"run_command","command":"/function blingedit:clone_air"},"color":"dark_green"},{"text":" ","color":"dark_green"},{"text":"[Don't Clone Air]","click_event":{"action":"run_command","command":"/function blingedit:dont_clone_air"},"color":"dark_green"}]
execute if score @s clone_in_place matches 1.. run tellraw @s ["",{"text":"Clone In Place: "},{"text":"[Enabled]","click_event":{"action":"run_command","command":"/function blingedit:toggle_clone_in_place"},"color":"green"}]
execute unless score @s clone_in_place matches 1.. run tellraw @s ["",{"text":"Clone In Place: "},{"text":"[Disabled]","click_event":{"action":"run_command","command":"/function blingedit:toggle_clone_in_place"},"color":"red"}]
tellraw @s ["",{"text":"Flip: "},{"text":"[Flip Left/Right]","click_event":{"action":"run_command","command":"/function blingedit:clone_flip_leftright"},"color":"dark_green"},{"text":" ","color":"dark_green"},{"text":"[Flip Front/Back]","click_event":{"action":"run_command","command":"/function blingedit:clone_flip_frontback"},"color":"dark_green"}]
tellraw @s ["",{"text":"Rotate: "},{"text":"[Rotate Left]","click_event":{"action":"run_command","command":"/function blingedit:clone_rotate_left"},"color":"dark_green"},{"text":" ","color":"dark_green"},{"text":"[Rotate Right]","click_event":{"action":"run_command","command":"/function blingedit:clone_rotate_right"},"color":"dark_green"}]
tellraw @s ["",{"text":"Actions: "},{"text":"[Confirm Clone]","click_event":{"action":"run_command","command":"/function blingedit:confirm_clone"},"color":"green"},{"text":" ","color":"green"},{"text":"[Clone&Repeat]","click_event":{"action":"run_command","command":"/function blingedit:clone_and_repeat"},"color":"green"},{"text":" ","color":"green"},{"text":"[Clone Brush]","click_event":{"action":"run_command","command":"/function blingedit:clone_brush"},"color":"green"},{"text":" ","color":"green"},{"text":"[Cancel]","click_event":{"action":"run_command","command":"/function blingedit:cancel"},"color":"green"}]