...
tellraw @s [""]
tellraw @s ["",{"text":"Move "},{"text":"Dest","color":"blue"},{"text":": ","color":"gray"},{"text":"[Up]","click_event":{"action":"run_command","value":"/function blingedit:move_up"},"color":"aqua"},{"text":" ","color":"aqua"},{"text":"[Down]","click_event":{"action":"run_command","value":"/function blingedit:move_down"},"color":"aqua"},{"text":" ","color":"aqua"},{"text":"[Left]","click_event":{"action":"run_command","value":"/function blingedit:move_left"},"color":"aqua"},{"text":" ","color":"aqua"},{"text":"[Right]","click_event":{"action":"run_command","value":"/function blingedit:move_right"},"color":"aqua"},{"text":" ","color":"aqua"},{"text":"[Forward]","click_event":{"action":"run_command","value":"/function blingedit:move_forward"},"color":"aqua"},{"text":" ","color":"aqua"},{"text":"[Backward]","click_event":{"action":"run_command","value":"/function blingedit:move_backward"},"color":"aqua"}]
tellraw @s ["",{"text":"Clone Options: "},{"text":"[Do Clone Air]","click_event":{"action":"run_command","value":"/function blingedit:clone_air"},"color":"dark_green"},{"text":" ","color":"dark_green"},{"text":"[Don't Clone Air]","click_event":{"action":"run_command","value":"/function blingedit:dont_clone_air"},"color":"dark_green"}]
execute if score @s clone_in_place matches 1.. run tellraw @s ["",{"text":"Clone In Place: "},{"text":"[Enabled]","click_event":{"action":"run_command","value":"/function blingedit:toggle_clone_in_place"},"color":"green"}]
execute unless score @s clone_in_place matches 1.. run tellraw @s ["",{"text":"Clone In Place: "},{"text":"[Disabled]","click_event":{"action":"run_command","value":"/function blingedit:toggle_clone_in_place"},"color":"red"}]
tellraw @s ["",{"text":"Flip: "},{"text":"[Flip Left/Right]","click_event":{"action":"run_command","value":"/function blingedit:clone_flip_leftright"},"color":"dark_green"},{"text":" ","color":"dark_green"},{"text":"[Flip Front/Back]","click_event":{"action":"run_command","value":"/function blingedit:clone_flip_frontback"},"color":"dark_green"}]
tellraw @s ["",{"text":"Rotate: "},{"text":"[Rotate Left]","click_event":{"action":"run_command","value":"/function blingedit:clone_rotate_left"},"color":"dark_green"},{"text":" ","color":"dark_green"},{"text":"[Rotate Right]","click_event":{"action":"run_command","value":"/function blingedit:clone_rotate_right"},"color":"dark_green"}]
tellraw @s ["",{"text":"Actions: "},{"text":"[Confirm Clone]","click_event":{"action":"run_command","value":"/function blingedit:confirm_clone"},"color":"green"},{"text":" ","color":"green"},{"text":"[Clone&Repeat]","click_event":{"action":"run_command","value":"/function blingedit:clone_and_repeat"},"color":"green"},{"text":" ","color":"green"},{"text":"[Clone Brush]","click_event":{"action":"run_command","value":"/function blingedit:clone_brush"},"color":"green"},{"text":" ","color":"green"},{"text":"[Cancel]","click_event":{"action":"run_command","value":"/function blingedit:cancel"},"color":"green"}]